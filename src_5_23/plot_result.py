...
#    plt.show()
    ...
    for step in range(numstep+1):
        ...
        omega_rx = action_dic[str(a)]     
        i1,out_fl=move_crowd(robot_flag = 1.0, render_flag = False, omega=omega_rx, numthstep=step, gener_flag=True) #robot_flag < 0 , no robot
...
#    plt.show()
    ...
    for step in range(numstep+1):
        ...
        omega_rx = action_dic[str(a)]     
        s,out_fl=move_crowd(robot_flag = 1.0, render_flag = False, omega=omega_rx, numthstep=step, gener_flag=True) #robot_flag < 0 , no robot
